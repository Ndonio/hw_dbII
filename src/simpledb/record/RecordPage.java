...
public class RecordPage {
   ...
   /** Creates the record manager for the specified block.
     ...
     */
   public RecordPage(Block blk, TableInfo ti, Transaction tx) { //prende info, calcola quando è grande un blocco, e fa la pin su quel blocco iniziando a scorrerlo!
      this.blk = blk;
      this.ti = ti;
      this.tx = tx;
   ...
   public String toString(){
	   String sep = ", ";
	   return "{ "
			   +"\ntabInfo :"+ this.ti.toString()
	   		   +"\nblk: "+this.blk+" "+sep
			   +"\nslotSize: "+this.slotsize+" "+sep
			   +"\ncurrSlot: "+this.currentslot+" "+sep
