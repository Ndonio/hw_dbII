...
public class SimpleDB {
	...
	public static String STRATEGY = "naive"; //help
	...
	public static void init(String dirname) {
		if(PRINTLOG){
			...
			timestamp = "log_"+timestamp+"_"+BUFFER_SIZE+"_"+STRATEGY+".txt";
			try{
				File logDir = new File(System.getProperty("user.home")+"/"+dirname+"_log");
				logDir.mkdir();
				File logFile = new File(logDir+"/"+timestamp);
				System.setOut(new PrintStream(logFile));	  

			}
			catch(Exception e ){
				e.printStackTrace();
				System.out.println("Something goes wrong with dir creation");
			}
		}
	...
	public static void init(String dirname, int buffersize, String strategy, boolean chatty, boolean printLog){
