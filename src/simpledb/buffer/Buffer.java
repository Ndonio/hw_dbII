...
public class Buffer {
	...
	/* COSE AGGIUNTE PER STATISTICHE */
	private int numOfPins = 0;
	private Long lastUnpinTimestamp;
	private Long readInTimestamp;
		
	public int getNumOfPins() {
		return this.numOfPins;
	}
	
	public void incNumOfPins(){
		this.numOfPins++;
	}
	
	public void resetNumOfPins(){
		this.numOfPins=0;
	}
	...
	public Long getReadInTimestamp() {
		return this.readInTimestamp;
	}

	public void setReadInTimestamp(Long timeReadIn) {
		this.readInTimestamp = timeReadIn;
	}

	
	/* FINE COSE AGGIUNTE PER STATISTICHE */
	 ...
	 */
	public Buffer() {
		long timestamp = Calendar.getInstance().getTimeInMillis();//aggiunta
		this.setLastUnpinTimestamp(timestamp); //aggiunta
		this.setReadInTimestamp(timestamp);
	}
	...
	void pin() {
		pins++;
		this.numOfPins++;//aggiunta
		this.setReadInTimestamp(Calendar.getInstance().getTimeInMillis()); //aggiunta
	...
	void unpin() {
		pins--;
		this.setLastUnpinTimestamp(Calendar.getInstance().getTimeInMillis()); //aggiunta
	}
	...
	/**
	 * Return a description for the page and it's details:
	 * <filename, numeroblocco, numeroPinAttivi>
	 * */
	@Override
	public String toString(){
		return (blk==null)?"page: EMPTY":"page: <"+ blk.fileName()+", "+ 
								blk.number()+", "+this.pins+", "+this.numOfPins+", "+this.getLastUnpinTimestamp()+", "+this.getReadInTimestamp()+">";
	}
